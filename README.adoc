image:https://travis-ci.org/learning-spring-boot/learning-spring-boot-code-1.2.svg?branch=master["Build Status", link="https://travis-ci.org/learning-spring-boot/learning-spring-boot-code-1.2"]
